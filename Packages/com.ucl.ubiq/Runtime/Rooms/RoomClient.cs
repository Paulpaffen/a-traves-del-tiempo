...
namespace Ubiq.Rooms
{
    ...
    public class RoomClient : MonoBehaviour
    {
        ...
        public static readonly float HeartbeatWarningThreshold = 15f;
        // Raised from 10s to 30s: on a congested 2.4GHz LAN with several Quests,
        // heartbeat replies can arrive late. The old 10s threshold triggered a
        // destructive disconnect+reconnect loop on transient latency. 30s gives
        // more tolerance before tearing the connection down.
        public static readonly float HeartbeatTimeoutThreshold = 30.0f;
